...
function Contact(props) {
    const fontVariantBig = props.screenSize ? "body1": "subtitle2";
    const fontVariantSmall = props.screenSize ? "caption": "body1";
    
    return(
        <div style={{marginTop: "100px"}}>
            <Grid container spacing={1} sx={{minHeight: 500, maxWidth:"100%", mx:"5%"}}>
                ...
                <Grid sm md display="flex" justifyContent="center" >
                    <Card sx={{m: props.screenSize ? "0px": "20px", backgroundColor: "rgba(200,200,200,0)", maxHeight: "300px", position: "relative" ,top: "45%", transform: "translate(0%, -50%)"}}>
